...
class blueServer(object):
    def __init__(self,log):
        ...
        self.serverSock.settimeout(600)#Throws a timeout exception if connections are idle for 10 minutes
        self.serverSock.listen(1)#set the socket to listen, now it's a server!
